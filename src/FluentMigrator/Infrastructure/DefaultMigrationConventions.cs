...
namespace FluentMigrator.Infrastructure
{
    public static class DefaultMigrationConventions
    {
        ...
        public static IMigrationInfo GetMigrationInfoFor(IMigration migration)
        {
            ...
            var migrationInfo = new MigrationInfo(migrationAttribute.Version, migrationAttribute.DbVersion, migrationAttribute.Description, migrationAttribute.Author, migrationAttribute.TransactionBehavior, migration);
